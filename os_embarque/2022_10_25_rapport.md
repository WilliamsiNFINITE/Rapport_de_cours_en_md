...
On remarque qu'on a des temps négatifs. J'ai donc manuellement nettoyer le fichier de résultat afin de n'avoir que des valeurs supérieures ou égales à 0.
...
Là encore j'ai enlevé les valeur négatives pour former le premier histogramme.
